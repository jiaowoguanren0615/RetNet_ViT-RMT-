...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'RetViT training and evaluation script', add_help=False)
    ...
    parser.add_argument('--sync-bn', default=False, help='Enable NVIDIA Apex or Torch synchronized BatchNorm. Usually used for training large-scale deep learning models, especially in multi-GPU or multi-node distributed environments')

    # Model parameters
    parser.add_argument('--model', default='RetViT_tiny', type=str, metavar='MODEL',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'RetViT training and evaluation script', parents=[get_args_parser()])
